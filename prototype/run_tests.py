...
in_directory = os.path.join(os.getcwd(), 'prototype/tests')
...
prototype_binary = sys.executable + ' ' + os.path.join(os.getcwd(), 'test_entryp.py')
...
class EvalTest(unittest.TestCase):
    ...
    def runTest(self):
        from prototype.prototypeapp import prototype_eval
        expected = eval(self.expression)
        actual = prototype_eval(self.expression)
