# Generated from PrototypeLexer.g4 by ANTLR 4.7.2
from antlr4 import *
...
if __name__ is not None and "." in __name__:
    from .PrototypeLexerBase import PrototypeLexerBase
else:
    from PrototypeLexerBase import PrototypeLexerBase
...
class PrototypeLexer(PrototypeLexerBase):
    ...
    literalNames = [ "<INVALID>",
            ...
            "'yield*'", "'class'", "'enum'", "'extends'", "'super'", "'const'", 
    ...
    symbolicNames = [ "<INVALID>",
            ...
            "QuestionMark", "QuestionMarkDot", "Colon", "Ellipsis", "Dot", 
            "PlusPlus", "MinusMinus", "Plus", "Minus", "BitNot", "Not", 
            "Multiply", "Divide", "Modulus", "Power", "NullCoalesce", "Hashtag", 
            ...
            "Switch", "While", "Debugger", "Function_", "This", "With", 
            "Default", "If", "Throw", "Delete", "In", "Try", "As", "From", 
            "Of", "Yield", "YieldStar", "Class", "Enum", "Extends", "Super", 
            "Const", "Export", "Import", "Async", "Await", "Implements", 
            "StrictLet", "NonStrictLet", "Private", "Public", "Interface", 
    ...
    ruleNames = [ "HashBangLine", "MultiLineComment", "SingleLineComment", 
                  ...
                  "As", "From", "Of", "Yield", "YieldStar", "Class", "Enum", 
    ...
    grammarFileName = "PrototypeLexer.g4"
