...
class PrototypeLexerBase(Lexer):
    def __init__(self, *args, **kwargs):
        super(PrototypeLexerBase, self).__init__(*args, **kwargs)
    ...
    def nextToken(self) -> Token:
        ...
        next_token: Token = super(PrototypeLexerBase, self).nextToken()
    ...
    def ProcessStringLiteral(self):
        if relativeImport:
            from .PrototypeLexer import PrototypeLexer
        else:
            from PrototypeLexer import PrototypeLexer
        if not self.lastToken or self.lastToken.type == PrototypeLexer.OpenBrace:
            text = self.text
    ...
    def IsRegexPossible(self) -> bool:
        ...
        if self.lastToken.type in [
                PrototypeLexer.Identifier,
                PrototypeLexer.NullLiteral,
                PrototypeLexer.BooleanLiteral,
                PrototypeLexer.This,
                PrototypeLexer.CloseBracket,
                PrototypeLexer.CloseParen,
                PrototypeLexer.OctalIntegerLiteral,
                PrototypeLexer.DecimalLiteral,
                PrototypeLexer.HexIntegerLiteral,
                PrototypeLexer.StringLiteral,
                PrototypeLexer.PlusPlus,
                PrototypeLexer.MinusMinus]:
            return False
    ...
    def reset(self):
        ...
        self.useStrictDefault = False
        self.useStrictCurrent = False
        super(PrototypeLexerBase, self).reset()
